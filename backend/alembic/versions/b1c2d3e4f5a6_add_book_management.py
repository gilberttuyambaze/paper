...
def upgrade():
    ...
    for name, column in [("ix_books_title", "title"), ("ix_books_isbn", "isbn"), ("ix_books_category", "category"), ("ix_books_subject", "subject"), ("ix_books_status", "status"), ("ix_books_visibility", "visibility"), ("ix_books_uploaded_by", "uploaded_by"), ("ix_books_created_at", "created_at"), ("ix_books_deleted_at", "deleted_at")]: op.create_index(name, "books", [column])
